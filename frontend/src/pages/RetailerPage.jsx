...
function RetailerPage({ setRole, user, onUpdateUser }) {
  ...
  const bottleData = {
    "1L": { price: prices.retailerOneLPrice, pieces: 12, name: "1 Litre Packs", desc: "12 bottles per box" },
    "500ml": { price: prices.retailerFiveHundredMLPrice, pieces: 24, name: "500ml Packs", desc: "24 bottles per box" },
    "200ml": { price: prices.retailerTwoHundredMLPrice, pieces: 48, name: "200ml Packs", desc: "48 bottles per box" }
  };
  ...
  const placeOrder = async () => {
    ...
    try {
      await axios.post("http://localhost:5000/orders/create", {
        ...
        location: data.location || "Store Pick-up / Shared Address",
      ...
      alert("Success! Your retail order has been placed in the FIFO queue.");
      setCart([]);
      setData(prev => ({
        ...prev,
        deliveryDate: "",
    ...
    <div className="app-container">
      ...
      <nav className="navbar">
        ...
        <div className="user-profile-badge">
          <span className="badge badge-role">Retailer Portal</span>
          <div 
      ...
      <div className="grid-2">
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
          ...
          <div className="card-section">
            ...
            <div className="input-group">
              <label className="input-label">Delivery Location / Drop-off Point</label>
              <input
                type="text"
                placeholder="E.g. Ground Floor Store, Backdoor entrance"
                value={data.location}
        ...
        {/* Right Column: Catalog Selector & Cart details */}
        <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
          ...
          <div className="card-section">
            ...
            <div className="product-grid">
              ...
              <div className="product-card">
                ...
                <div className="product-price-tag">₹{prices.retailerOneLPrice}<span style={{ fontSize: "11px", color: "var(--text-muted)", fontWeight: "normal" }}>/box</span></div>
              ...
              <div className="product-card">
                ...
                <div className="product-price-tag">₹{prices.retailerFiveHundredMLPrice}<span style={{ fontSize: "11px", color: "var(--text-muted)", fontWeight: "normal" }}>/box</span></div>
                <div className="product-input-qty-row">
                  <input
                    type="number"
                    min="1"
              ...
              <div className="product-card">
                ...
                <div className="product-price-tag">₹{prices.retailerTwoHundredMLPrice}<span style={{ fontSize: "11px", color: "var(--text-muted)", fontWeight: "normal" }}>/box</span></div>
                <div className="product-input-qty-row">
                  <input
                    type="number"
                    min="1"
            ...
            >
              {isSubmitting ? (
                <>
                  ...
                  Placing Retail Order...
                </>
              ) : (
                "Place Retail Order (FIFO)"
              )}
            </button>
          </div>
        ...
        <div className="modal-overlay" onClick={() => setSelectedOrder(null)}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()} style={{ maxWidth: "500px", padding: "24px" }}>
            ...
            <div className="receipt" style={{ background: "#f8fafc", padding: "20px", borderRadius: "8px", border: "1px solid #cbd5e1", margin: "10px 0 20px 0" }}>
              ...
              <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "6px", fontSize: "12px" }}><span style={{ color: "#64748b" }}>Client Type:</span><span style={{ fontWeight: "600" }}>{selectedOrder.clientType || "Retailer"}</span></div>
